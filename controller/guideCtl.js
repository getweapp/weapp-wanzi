    ...
    render() {
        ...
        this._renderFromCache_(
            ()=>{
                ...
                this._fetchAndRender_(conf.api.album + this.uid, (data)=>{
                    ...
                    this._fetchAndRender_(conf.api.points, (data)=>{
                        ...
                        this._fetchAndRender_(conf.api.passport + this.uid, (data)=>{
                            this._renderPassport_(data);
                        
                        });
               

                    //提示：WAService.js:1 TypeError: Promise is not a constructor，所以还是采用callback访问
                    /*
